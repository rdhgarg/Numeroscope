...
public class NeutralProfessionAdapter extends RecyclerView.Adapter<NeutralProfessionAdapter.MyViewHolder> {
    private Context context;
    ArrayList<GetReportResBean.NaturalProffessionDTO> list;

    public NeutralProfessionAdapter(Context context, ArrayList<GetReportResBean.NaturalProffessionDTO> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        GetReportResBean.NaturalProffessionDTO model = list.get(position);
