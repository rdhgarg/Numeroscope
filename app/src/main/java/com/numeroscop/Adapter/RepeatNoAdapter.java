...
public class RepeatNoAdapter  extends RecyclerView.Adapter<RepeatNoAdapter.MyViewHolder> {
    private Context context;
    ArrayList<GetReportResBean.RepeatNoDTO> list;
    private String lng;



    public RepeatNoAdapter(Context context, ArrayList<GetReportResBean.RepeatNoDTO> list,String lng) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_repeat_number,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        GetReportResBean.RepeatNoDTO model = list.get(position);

        holder.textNumber.setText("Repeat No. "+model.getNumber());
