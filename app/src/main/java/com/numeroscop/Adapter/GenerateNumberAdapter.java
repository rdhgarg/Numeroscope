...
public class GenerateNumberAdapter extends RecyclerView.Adapter<GenerateNumberAdapter.MyViewHolder> {

    ArrayList<NumberModel> list;
    Context context;
    GetNumberResBean.Data tableData;

    public GenerateNumberAdapter(ArrayList<NumberModel> list, GetNumberResBean.Data tableData, Context context) {
        this.list = list;
