...
public class IntellectualAdapter extends RecyclerView.Adapter<IntellectualAdapter.MyViewHolder> {
    private Context context;
    ArrayList<NumberModel> list;
    ArrayList<String> numberModelArrayList;


    public IntellectualAdapter(Context context, ArrayList<NumberModel> list,ArrayList<String> numberModelArrayList ) {
