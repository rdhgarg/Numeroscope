...
public class SpiritualAdapter extends RecyclerView.Adapter<SpiritualAdapter.MyViewHolder> {
    private Context context;
    ArrayList<NumberModel> list;
    ArrayList<String> numberModelArrayList;


    public SpiritualAdapter(Context context, ArrayList<NumberModel> list,ArrayList<String> numberModelArrayList ) {
