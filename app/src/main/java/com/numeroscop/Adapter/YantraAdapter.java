...
public class YantraAdapter extends RecyclerView.Adapter<YantraAdapter.MyViewHolder> {

    Context context;
    List<YantraBraceletResBean.Data.YantraItem> yantraList;
    ItemClickListner listner;

    public YantraAdapter(Context context, List<YantraBraceletResBean.Data.YantraItem> yantraList, ItemClickListner listner) {
    ...
    public interface ItemClickListner{
        void onYantraClicked(int poisition);
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.consRoot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                listner.onYantraClicked(position);
            }
        });
    }
