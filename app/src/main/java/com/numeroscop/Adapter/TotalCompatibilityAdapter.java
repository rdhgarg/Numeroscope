...
public class TotalCompatibilityAdapter extends RecyclerView.Adapter<TotalCompatibilityAdapter.MyViewHolder> {
    ...
    public TotalCompatibilityAdapter(ArrayList<NumberModel> list,  List<Integer> cal, Context context) {
        this.list = list;
