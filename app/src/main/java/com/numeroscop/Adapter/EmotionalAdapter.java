...
public class EmotionalAdapter extends RecyclerView.Adapter<EmotionalAdapter.MyViewHolder> {
    private Context context;
    ArrayList<NumberModel> list;
    ArrayList<String> numberModelArrayList;


    public EmotionalAdapter(Context context, ArrayList<NumberModel> list,ArrayList<String> numberModelArrayList ) {
        ...
        if (position == 3|| position == 4 || position == 5) {
            if (position == 3) {
                ...
                if (Integer.parseInt(numberModelArrayList.get(1)) != 0) {
                    ...
                    holder.txtNumber.setText("");
                   // holder.consRoot.setBackgroundColor(context.getResources().getColor(R.color.a));
                }
            } else if (position == 5) {
                if (Integer.parseInt(numberModelArrayList.get(2)) != 0) {
                    ...
                    holder.txtNumber.setText("");
                  //  holder.consRoot.setBackgroundColor(context.getResources().getColor(R.color.white));
                }
            } else {
                holder.txtNumber.setText("");
               // holder.consRoot.setBackgroundColor(context.getResources().getColor(R.color.white));
