...
public class PracticalAdapter extends RecyclerView.Adapter<PracticalAdapter.MyViewHolder> {
    private Context context;
    ArrayList<NumberModel> list;
    ArrayList<String> numberModelArrayList;


    public PracticalAdapter(Context context, ArrayList<NumberModel> list,ArrayList<String> numberModelArrayList ) {
